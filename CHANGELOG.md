...
- feat(**main**.py): exit typer app when mysql upate operation is done ([`c2146bb`](https://github.com/poneoneo/Alibaba-Scrapper/commit/c2146bbdd0b5084c845256a8ad4eac4142308441))
...
- feat(**main**): show success message after db init command ([`d445671`](https://github.com/poneoneo/Alibaba-Scrapper/commit/d4456719ff1666387d3d9c0f1da5d199f2e4f16a))
...
- fix(aba_cli_scrapper\_\_main\_\_): add pymysql as DBAPI while initializing mysql database without auto-fill flag ([`8ab4437`](https://github.com/poneoneo/Alibaba-Scrapper/commit/8ab4437d5ddd8acd31724db9ffb78706ba07e0a0))
...
- refactor(ali2b-cli-scrapper): remove **main** from ignore file ([`60c0c52`](https://github.com/poneoneo/Alibaba-Scrapper/commit/60c0c52bb80c8a973b21b3cf9eeb3f7cb64b5630))
...
- refactor(gitignore): add **main** to .gitignore file ([`4e4e9ea`](https://github.com/poneoneo/Alibaba-Scrapper/commit/4e4e9eab2bfd0e61822f119dcbb809edc17a8732))
...
- style(**main**.py): update error message for export-as-csv subcommand ([`f691533`](https://github.com/poneoneo/Alibaba-Scrapper/commit/f691533b47038458a0242ae5983d36c0f7fdf9c3))
...
- style(project licence): add gpl licence on top of **main**.py ([`270a4ae`](https://github.com/poneoneo/Alibaba-Scrapper/commit/270a4ae2a5c3f3132d821a1167780cce9fb9a8e0))
...
- add gpl licence on top of **main**.py ([`61b3989`](https://github.com/poneoneo/Alibaba-Scrapper/commit/61b3989b8c3823329dc0a7c8a97d505a62cca6ec))
...
- remove **main** from ignore file ([`f8d2eb9`](https://github.com/poneoneo/Alibaba-Scrapper/commit/f8d2eb95b39c5e78898d4135e9172ddb9eb998a0))
...
- add **main** to .gitignore file ([`d3c7796`](https://github.com/poneoneo/Alibaba-Scrapper/commit/d3c7796d49fd0dc12e85c2c5c3ada84b66b95e48))
